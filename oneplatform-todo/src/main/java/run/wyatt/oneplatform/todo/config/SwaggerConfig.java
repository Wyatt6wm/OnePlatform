...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)  // 定义是Swagger2文档
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("run.wyatt.oneplatform.todo.controller"))   // 扫描制定包下的接口
                .paths(PathSelectors.ant("/api/todo/**"))    // 筛选制定的请求路径
                .build()
